...
export async function moveTraining(trainingId: string, newDate: string, reason = "Movido no calendário") {
...
export async function reorganizeWeek(startDate: string, endDate: string, note = "") {
  ...
  return data as { message: string; changes: Array<{id:string;date:string;reason?:string}> };
}
